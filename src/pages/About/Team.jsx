  ...
  return (
    <section className="py-20 bg-black">
      <div className="container mx-auto px-5">
        ...
        <div className="team-form grid grid-cols-2 sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-4 justify-center">
          {teamData.map((member) => (
            <Card
              key={member.id}
              bordered={false}
              className={`shadow-lg rounded-lg bg-gradient-to-r from-purple-800 to-blue-800 p-4 flex flex-col items-center ${
                member.id === 1
                  ? "col-span-2 justify-center mx-auto"
                  : ""
              }`}
              style={{ width: member.id === 1 ? "80%" : "100%" }}
            >
              <div className="flex flex-col items-center mb-3">
                ...
                <p className="text-sm text-center font-bold mb-2 text-white">
                  {member.position}
                </p>
              </div>
